...
mod tests {
    ...
    fn test_grey_skin_uses_terminal_default() {
        ...
        assert_eq!(fg, [170, 170, 170, 255], "Grey skin should use terminal default fg");
    }
    ...
    fn test_gold_skin_fg_color() {
        ...
        assert_eq!(fg, [255, 204, 0, 255], "Gold skin should recolor to [255, 204, 0]");
    }
    ...
    fn test_pink_skin_fg_color() {
        ...
        assert_eq!(fg, [255, 0, 255, 255], "Pink skin should recolor to [255, 0, 255]");
    }
