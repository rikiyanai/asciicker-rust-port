...
mod tests {
    ...
    fn test_render_menu_highlights_selected() {
        ...
        assert_eq!(grid.fg_colors[idx0], unselected_fg, "Unselected item should be white");
        ...
        assert_eq!(grid.fg_colors[idx1], selected_fg, "Selected item should be gold");
        assert_eq!(grid.char_indices[idx1], b'>' as u16, "Selected item should have '>' prefix");
    }
