    ...
    fn ray_vs_instance(
        ...
        match inst {
            RuntimeInstance::Mesh {
                ...
                let origin_f32 = [
                    origin_local.x as f32,
                    origin_local.y as f32,
                    origin_local.z as f32,
                ];
                let dir_f32 = [
                    dir_local_norm.x as f32,
                    dir_local_norm.y as f32,
                    dir_local_norm.z as f32,
                ];
                ...
                for face in &mesh.faces {
                    ...
                    let tri = [[v0.x, v0.y, v0.z], [v1.x, v1.y, v1.z], [v2.x, v2.y, v2.z]];

                    if let Some(toi_local) =
                        ray_triangle_intersection(&origin_f32, &dir_f32, &tri, current_max_local)
                    {
            ...
            RuntimeInstance::Sprite { .. } | RuntimeInstance::Item { .. } => None,
        }
    }
}
