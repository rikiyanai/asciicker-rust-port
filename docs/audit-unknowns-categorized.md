...
| Document | Content |
|----------|---------|
| docs/research-bug-assumption-audit.md | Primary audit, 15 listed unknowns |
| docs/research-rendering-deep-dive.md | Rendering pipeline details |
| docs/research/alexharri-asciicker-integration.md | Alex Harri integration |
| docs/alexharri_ascii_renderer_technology.md | Shape-matching overview |
