...
Non-canonical worksheet inventory. Durable truths belong in [`docs/CANONICAL_SPEC.md`](../CANONICAL_SPEC.md) and [`docs/FAILURE_LOG.md`](../FAILURE_LOG.md).

## Start Here
- [Canonical Spec](../CANONICAL_SPEC.md) - Durable architecture, decision, and code/doc truth
- [Failure Log](../FAILURE_LOG.md) - Durable failures, blockers, regressions, and proof gaps
...
### Per-File Documentation (docs/worksheets/arch/)
...
- [docs/worksheets/archive/](archive/) - Legacy and superseded documents
...
- [docs/worksheets/archive/engine-port-magecore/](archive/engine-port-magecore/) - Archive backup copies of engine port docs (active copies restored to [docs/worksheets/engine-port/](engine-port/))
...
- [docs/worksheets/verification/](verification/) - Evidence artifacts directory (empty - populated by verification runs)
