...
└── docs/worksheets/
    ...
    │
    ├── CODE DOCS (4 files, docs/worksheets/ only — 2 more at root)
...
| Process | 5 | `docs/worksheets/` | State, failures, assumptions, risks, decisions |
| Gaps | 6 | `docs/worksheets/` | Gap analysis documents (master + 5 topic files) |
| Research | 21 | `docs/worksheets/` + `docs/worksheets/research/` | Technology analysis, integration |
| Audit | 29 | `docs/worksheets/` | Unknowns, re-audits, phase audits, checkpoints |
| Plans | 9 | `docs/worksheets/` | Implementation, bug fixes, granular tasks |
| Code Docs | 4 | `docs/worksheets/` | C++ format/constant documentation (+ 2 at root) |
| Skills | 4 | `docs/worksheets/skills/` | Skill packs for engine subsystems |
| Arch | 42 | `docs/worksheets/arch/` | Function-level C++ documentation |
| Engine-port | 7 | `docs/worksheets/engine-port/` | Bevy/magecore port evaluation (2026-02-18) |
| Other | 3 | `docs/worksheets/` | MASTER_INDEX, INDEX, AGENT_PROTOCOL |
| **ACTIVE TOTAL** | **135** | | Complete project documentation |
| Archive | 9 | `docs/worksheets/archive/` | Superseded documents (not counted above) |
...
- `audio.cpp` — audio is covered in `docs/worksheets/arch/batch_audio.md` and `docs/worksheets/arch/stb_vorbis_cpp.md`
...
| Implementation plan | `docs/worksheets/IMPLEMENTATION_PLAN.md` |
| All assumptions | `docs/worksheets/ASSUMPTION_MASTER_CHECKLIST.md` |
| Known issues | `docs/FAILURE_LOG.md` |
| Technical details | `docs/worksheets/arch/*.md` |
| C++ format docs | `docs/worksheets/codedoc-*.md` and root `codedoc-*.md` |
| Gap analysis | `docs/worksheets/GAPS_ANALYSIS_SUMMARY.md` |
| Agent protocol | `docs/worksheets/AGENT_PROTOCOL.md` |
| Agent roster | `AGENTS.md` (root) |
| Risk tracking | `docs/worksheets/RISK_REGISTER.md` |
