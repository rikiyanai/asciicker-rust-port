...
This document details the perspective projection implementation found in `/Users/rikihernandez/Downloads/Aciicker-Y9-2/render.cpp`. The original codebase uses a custom perspective projection that does not use a standard 4x4 perspective matrix.
